<script setup>
  ...
  const handleSubmit = () => {
    ...
    // Tu peux ici appeler une API ou stocker en localStorage selon tes besoins
          ...
          <form @submit.prevent="handleSubmit">
            <div class="row g-3">
              ...
              <div class="col-md-4">
                ...
                <input v-model="prixVente" type="number" class="form-control" id="prixVente" required />
              </div>
              <div class="col-md-4">
                <label for="type" class="form-label">Type</label>
                <input v-model="type" type="text" class="form-control" id="type" required />
              </div>
              <div class="col-md-4">
                <label for="famille" class="form-label">Famille</label>
                <input v-model="famille" type="text" class="form-control" id="famille" required />
              </div>
              <div class="col-md-4">
